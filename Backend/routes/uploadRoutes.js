...
const fs = require('fs');
const { verifyToken, isRepresentativeOrAdmin } = require('../middleware/auth');
...
// ✅ Use isRepresentativeOrAdmin so both representative and admin can upload content images
router.post('/upload', verifyToken, isRepresentativeOrAdmin, (req, res) => {
